...
> [!summary] Текущий прогресс (см. таски ниже): **1.1–1.9, 1.11 (частично), 1.12 — done**, **1.10 LetterReview — current**. Открытый гэп: AILayer не пересобирается на PUT /settings (1.11/1.12), и Settings UI пока без редактора `llm_deployments` (passthrough).
...
### 1.10 UI: LetterReview — `M` — **current**
